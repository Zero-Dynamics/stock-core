...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CStockAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CStockAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CStockAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CStockAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CStockAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CStockAddress(arr[0].get_str()).Get() == demoAddress.Get());
