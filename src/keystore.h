...
#ifndef STOCK_KEYSTORE_H
#define STOCK_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/stock/bips/blob/master/bip-0013.mediawiki
