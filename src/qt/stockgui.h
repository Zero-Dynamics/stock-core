...
#ifndef STOCK_QT_STOCKGUI_H
#define STOCK_QT_STOCKGUI_H
...
/**
  Stock GUI main class. This class represents the main window of the Stock UI. It communicates with both the client and
...
public:
    ...
    explicit StockGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~StockGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a stock wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
