...
StockUnits::StockUnits(QObject *parent):
    QAbstractListModel(parent),
    unitlist(availableUnits())
{
}

QList<StockUnits::Unit> StockUnits::availableUnits()
{
    QList<StockUnits::Unit> unitlist;

    unitlist.append(ODYNS); // Stock
...
bool StockUnits::valid(int unit)
{
    switch(unit)
    {
        case ODYNS:
...
QString StockUnits::name(int unit, bool fPrivate)
{
    switch(unit)
    {
...
QString StockUnits::description(int unit)
{
    switch(unit)
    {
        case ODYNS: return QString("Stock");
...
qint64 StockUnits::factor(int unit)
{
...
int StockUnits::decimals(int unit)
{
    switch(unit)
    {
        case ODYNS: return 8;
...
QString StockUnits::format(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators, bool fPretty)
{
...
QString StockUnits::pretty(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators)
{
...
// appropriate.
QString StockUnits::formatWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool fPrivate)
{
    return QString("%1 %2").arg(format(unit, amount, plussign, separators), name(unit, fPrivate));
}

QString StockUnits::prettyWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool fPrivate)
{
    return QString("%1 %2").arg(pretty(unit, amount, plussign, separators), name(unit, fPrivate));
}

QString StockUnits::formatHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool removeTrailing, bool fPrivate)
{
...
bool StockUnits::parse(int unit, const QString &value, CAmount *val_out)
{
...
QString StockUnits::getAmountColumnTitle(int unit)
{
    QString amountTitle = QObject::tr("Amount");
    if (StockUnits::valid(unit))
    {
        amountTitle += " ("+StockUnits::name(unit) + ")";
    }
    return amountTitle;
}

int StockUnits::rowCount(const QModelIndex &parent) const
{
    Q_UNUSED(parent);
    return unitlist.size();
}

QVariant StockUnits::data(const QModelIndex &index, int role) const
{
    int row = index.row();
