...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", StockUnits::ODYNS);
    nDisplayUnit = settings.value("nDisplayUnit").toInt();

    if (!settings.contains("strThirdPartyTxUrls"))
        settings.setValue("strThirdPartyTxUrls", "https://www.stockexplorer.com/tx/%s");
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://www.stockexplorer.com/tx/%s").toString();
...
void OptionsModel::checkAndMigrate()
{
    ...
    if (settingsVersion < CLIENT_VERSION)
    {
        ...
        // see https://github.com/stock/stock/pull/8273
