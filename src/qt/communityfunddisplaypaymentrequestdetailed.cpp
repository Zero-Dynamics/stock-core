...
void CommunityFundDisplayPaymentRequestDetailed::setPrequestLabels() const
{
    ...
    // Link
    ui->labelPrequestLink->setText(QString::fromStdString("https://www.odynsexplorer.com/dao/payment-request/" + prequest.hash.ToString()));
    ...
    //set hyperlink for odynscommunity proposal view
