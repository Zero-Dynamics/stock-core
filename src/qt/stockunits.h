...
#ifndef STOCK_QT_STOCKUNITS_H
#define STOCK_QT_STOCKUNITS_H
...
/** Stock unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class StockUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit StockUnits(QObject *parent);

    /** Stock units.
      @note Source: https://en.stock.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        // Base currencies
...
typedef StockUnits::Unit StockUnit;

#endif // STOCK_QT_STOCKUNITS_H
