...
- Accepts URI to sign messages.
    - URIs of the format stock:http://domain/something/?a=stock_address&m=some_message will make the wallet to sign “some_message” and return the produced signature as a POST request to the URL specified in the URI.
...
- stock-tx tool has been updated to use stock’s own transaction structure
