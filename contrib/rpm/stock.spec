...
%{_sbindir}/semanage port -a -t stock_port_t -p tcp 5555
%{_sbindir}/semanage port -a -t stock_port_t -p tcp 5556
%{_sbindir}/semanage port -a -t stock_port_t -p tcp 15555
%{_sbindir}/semanage port -a -t stock_port_t -p tcp 15556
