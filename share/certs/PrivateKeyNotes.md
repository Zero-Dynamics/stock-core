...
unlocked to sign the Stock-Qt.app bundle.
...
allowing somebody to distribute a Stock-Qt.app or stock-qt-setup.exe with a valid
...
that the stock-qt.exe file inside the installer had not been tampered with.
