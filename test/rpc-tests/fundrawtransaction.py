...
class RawTransactionsTest(StockTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid stock address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid stock address" in e.error['message'])
